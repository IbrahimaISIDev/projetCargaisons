...
if (!isset($_SESSION['cargaisons'])) {
    $data = file_get_contents(__DIR__ . '/../data/listCargo.json');
...
<div class="p-4 mt-8 sm:ml-64">
    ...
    <div class="min-h-screen bg-gray-100 flex flex-col">
        ...
        <main class="flex-1 p-6">
                ...
                <div class="min-h-screen max-w-12xl bg-gray-100 py-6">
                    <div class="max-w-full mx-auto bg-white shadow rounded-lg p-6">
                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody id="cargo-list">
                                <?php foreach ($_POST['cargaisons'] as $cargaison) : ?>
                                    <tr>
                                        <td><?php echo $cargaison['idcargo']; ?></td>
                                        <td><?php echo $cargaison['type']; ?></td>
                                        <td><?php echo $cargaison['dateDepart']; ?></td>
                                        <td><?php echo $cargaison['dateArrivee']; ?></td>
                                        <td><?php echo $cargaison['distance']; ?></td>
                                        <td><?php echo $cargaison['etat']; ?></td>
                                        <td><?php echo $cargaison['status']; ?></td>
                                        <td><?php echo $cargaison['details']; ?></td>
                                        <td>
                                            <button class="editBtn" data-id="<?php echo $cargaison['idcargo']; ?>">Modifier</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                    ...
                    <div class="bg-white rounded-lg p-4 relative w-full max-w-2xl">
                        ...
                        <form id="addCargoForm" method="post" class="space-y-4">
                            ...
                            <div class="flex justify-between">
                                ...
                                <button id="addCargoSubmitBtn" type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Ajouter</button>
                                <!-- <button type="button" class="bg-red-500 text-white px-4 py-2 rounded" id="cancelBtn">Annuler</button>
            ...
            <script src="/var/www/html/projetCargaisons/dist/jsondata.js"></script>
            <script>
